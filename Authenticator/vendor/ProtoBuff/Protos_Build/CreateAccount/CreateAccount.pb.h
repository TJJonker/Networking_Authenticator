...
#ifndef GOOGLE_PROTOBUF_INCLUDED_CreateAccount_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_CreateAccount_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_CreateAccount_2eproto
...
struct TableStruct_CreateAccount_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_CreateAccount_2eproto;
namespace Database {
class CreateAccount;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::Database::CreateAccount* Arena::CreateMaybeMessage<::Database::CreateAccount>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Database {
...
class CreateAccount final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Database.CreateAccount) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Database.CreateAccount)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_CreateAccount_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CreateAccount::requestid() const {
  // @@protoc_insertion_point(field_get:Database.CreateAccount.requestID)
...
inline void CreateAccount::set_requestid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:Database.CreateAccount.requestID)
}
...
inline const std::string& CreateAccount::email() const {
  // @@protoc_insertion_point(field_get:Database.CreateAccount.email)
  return _internal_email();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CreateAccount::set_email(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 email_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Database.CreateAccount.email)
}
inline std::string* CreateAccount::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:Database.CreateAccount.email)
  return _s;
}
inline const std::string& CreateAccount::_internal_email() const {
  return email_.Get();
}
inline void CreateAccount::_internal_set_email(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  email_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CreateAccount::_internal_mutable_email() {
  _has_bits_[0] |= 0x00000001u;
  return email_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CreateAccount::release_email() {
  // @@protoc_insertion_point(field_release:Database.CreateAccount.email)
...
inline void CreateAccount::set_allocated_email(std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Database.CreateAccount.email)
}

// required string password = 3;
inline bool CreateAccount::_internal_has_password() const {
...
inline const std::string& CreateAccount::password() const {
  // @@protoc_insertion_point(field_get:Database.CreateAccount.password)
  return _internal_password();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CreateAccount::set_password(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Database.CreateAccount.password)
}
inline std::string* CreateAccount::mutable_password() {
  std::string* _s = _internal_mutable_password();
  // @@protoc_insertion_point(field_mutable:Database.CreateAccount.password)
  return _s;
}
inline const std::string& CreateAccount::_internal_password() const {
  return password_.Get();
}
inline void CreateAccount::_internal_set_password(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CreateAccount::_internal_mutable_password() {
  _has_bits_[0] |= 0x00000002u;
  return password_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CreateAccount::release_password() {
  // @@protoc_insertion_point(field_release:Database.CreateAccount.password)
...
inline void CreateAccount::set_allocated_password(std::string* password) {
  ...
  password_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), password,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:Database.CreateAccount.password)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_CreateAccount_2eproto
