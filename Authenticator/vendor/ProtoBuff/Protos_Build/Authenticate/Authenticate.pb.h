...
PROTOBUF_NAMESPACE_OPEN
template<> ::Database::Authenticate* Arena::CreateMaybeMessage<::Database::Authenticate>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Database {
...
class Authenticate final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Database.Authenticate) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Database.Authenticate)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Authenticate::requestid() const {
  // @@protoc_insertion_point(field_get:Database.Authenticate.requestID)
...
inline void Authenticate::set_requestid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:Database.Authenticate.requestID)
}
...
inline const std::string& Authenticate::email() const {
  // @@protoc_insertion_point(field_get:Database.Authenticate.email)
...
void Authenticate::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 email_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Database.Authenticate.email)
}
inline std::string* Authenticate::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:Database.Authenticate.email)
  return _s;
}
...
inline std::string* Authenticate::release_email() {
  // @@protoc_insertion_point(field_release:Database.Authenticate.email)
...
inline void Authenticate::set_allocated_email(std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Database.Authenticate.email)
}
...
inline const std::string& Authenticate::password() const {
  // @@protoc_insertion_point(field_get:Database.Authenticate.password)
  return _internal_password();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Authenticate::set_password(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Database.Authenticate.password)
}
inline std::string* Authenticate::mutable_password() {
  std::string* _s = _internal_mutable_password();
  // @@protoc_insertion_point(field_mutable:Database.Authenticate.password)
  return _s;
}
...
inline std::string* Authenticate::release_password() {
  // @@protoc_insertion_point(field_release:Database.Authenticate.password)
...
inline void Authenticate::set_allocated_password(std::string* password) {
  ...
  password_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), password,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:Database.Authenticate.password)
}
